...
import com.ymwoo.project.blog.BlogRepository;
...
public class BlogControllerTest
{
    ...
    List<Blog>     dbList = new ArrayList<>();
    ...
    void init()
    {
        ...
        for ( int loop : new int[10] )
        {
            ...
            Blog resource = this.repository.save(blog);
            this.dbList.add(resource);
    ...
    @Test
    @DisplayName("init에 등록 한 데이터 중 id항목을 조회")
    @WithMockUser(username = "test",
                  roles = { "USER" })
